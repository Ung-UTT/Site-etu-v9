 ...
 *
 * Date: Thu Mar 15 17:13:44 2012 +0100
 *
 */
...
var defaults = {
  ...
  // display
  defaultView: 'agendaWeek', // Dorian : Agenda semaine
  aspectRatio: 1.35,
  header: {
    left: 'title',
    center: '',
  ...
  weekends: false, // Dorian : cache dimanche
  weekendDays: [0], // being an array deep merge can't override it, look into main.js
  ...
  titleFormat: {
    month: 'MMMM yyyy',
    week: "d MMMM{'&#8212;' d MMMM} yyyy", // Dorian : 4 septembre - 5 septembre 2012
    day: 'dddd, MMM d, yyyy'
  },
  columnFormat: {
    month: 'ddd',
  ...
  // locale
  isRTL: false,
  firstDay: 1, // Dorian : Lundi en premier jour
...
setDefaults({
  allDaySlot: false, // Dorian : pas de "all day"
  allDayText: 'all-day',
  firstHour: 8, // Dorian : commence à 8h
  slotMinutes: 30,
  defaultEventMinutes: 120,
  axisFormat: "H'h'(mm)", // Dorian : affiche 8h, 8h30, ...
  timeFormat: {
    agenda: '' // Dorian : n'affiche rien en dessus des horaires
  },
  dragOpacity: {
    agenda: .5
  },
...
function AgendaEventRenderer() {
  ...
  function renderSlotSegs(segs, modifiedEventId) {
    ...
    for (i=0; i<segCnt; i++) {
      ...
      if (true) { // Dorian : Toujours afficher les horaires en indentées
        // indented and thin
