SiteEtu::Application.routes.draw do
  ...
  # Routes spéciales
  get 'about' => 'home#about', via: :get
  get 'rules' => 'home#rules', via: :get
  get 'deploy' => 'application#deploy', via: :get
  get 'preview' => 'application#preview' # Prévisualisation Markdown
